...
import com.example.birdnest.data.model.KycStatus
...
class FirebaseAuthRepository @Inject constructor(
    ...
    override suspend fun sendOtp(email: String): Result<Unit> = try {
    ...
    override suspend fun verifyOtp(email: String, otp: String): Result<User> = try {
    ...
    override suspend fun registerOwner(email: String, password: String): Result<User> = try {
